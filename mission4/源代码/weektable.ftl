...
<head>
    ...
    <script type="text/javascript" src="js/attendce/census.js"></script>
</head>
<body>
        ...
        <div class="box">
            <div class="box-header ">
                ...
                <div class="input-group" style="width:150px;float:right;top:-5px">
                    ...
                    <input type="text" style="top: 5px" class=" input-sm pull-right baseKey" value="${(baseKey)!''}"
                           placeholder="查找..."/>
                    ...
                    <button id="censusBtn" type="button" class="btn btn-success  btn-sm"
                            style="top: -1px">统计
                    </button>
                ...
                <div class="box-body">
                    ...
                    <div id="census" class="thistable" hidden="hidden">
                        <#include "/attendce/censusTable.ftl">
                    </div>
                </div>
            </div>
        </div>
